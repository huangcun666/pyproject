...
define('mysql_database',default='TODO',help='db database')
...
settings['mysql_host']=options.mysql_host
settings['mysql_database']=options.mysql_database
settings['mysql_user']=options.mysql_user
settings['mysql_password']=options.mysql_password
